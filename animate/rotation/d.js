...
var D_rotation = {
    ...
    timerNextPage: '' ,//翻页时间
    Aswitch: '', //动画开关
    newrotation: true,//新竖直滚动
    vTickerID: 'news-vTicker_container'//竖直滚动所需要的ID
}
var rotation = {
        ...
        function startAnimate() {
            ...
            if (D.newrotation) {
				...
				$('#' + D.vTickerID).vTicker({
					speed: 500, //滚动速度
					pause: 4000, //滚动间歇
					animation: 'fade', //默认为空，'fade'表示移动时，首位淡入淡出
					mousePause: true, //布尔值 true 鼠标悬停是否停止滚动
					showItems: 1, //显示滚动行数
					direction: 'up', //滚动方向
				})
				var Rli = $('#' + D.vTickerID).find('li');
				var Rli_l = Rli.length;
				//从上往下滚动时，当长度-1等于vTicker里的num时表示所有内容均以滚动完成，此时需要翻页
			}else{
