        ...
        function _224() {
            if (opts.noheader || (!opts.title && !opts.header)) {
                ...
                if (opts.header) {
                    ...
                    if (!_228.length) {
                        /*$("<div class=\"promptBox\"><div class=\"boxBody\"><div class=\"boxBodyWrapper\"><div class=\"boxBodyText\"><i class=\"boxBodyTextIcon icon iconfont\">&#xe936;</i><span class=\"boxBodyTextTitle\">保存成功</span></div><div class=\"boxBodyBtnsBox\"><button class=\"boxBodyBtn boxBodyBtnsPrimary\" type=\"button\"><span>确定</span></button></div></div></div></div>").appendTo(_223);*/
...
(function($) {
    ...
    function _280(_281) {
        ...
        var win = $(_281).panel($.extend({}, _282.options, {
            ...
            headerCls: "window-header newWindowHeader" + (opts.headerCls || ""),
            bodyCls: "window-body newWindowBody" + (opts.noheader ? "window-body-noheader" : " ") + (opts.bodyCls || ""),
            onBeforeDestroy: function() {
    ...
    function _295(_296) {
        ...
        if (opts.buttons) {
            if ($.isArray(opts.buttons)) {
                ...
                var win2 = $("div.messager-body")
                var _298 = $("<div class=\"dialog-button\"></div>").appendTo(win2);
                for (var i = 0; i < opts.buttons.length; i++) {
                    var p = opts.buttons[i];
                    var _299 = $("<a href=\"javascript:void(0)\" class=\"newButtonStyle\"></a>").appendTo(_298);
                    if (p.handler) {
...
(function($) {
    ...
    function _2b2(_2b3) {
        ...
        var win = dlg.dialog("dialog").addClass("messager-window prompt");
    ...
    $.messager = {
        ...
        alert: function(_2b6, msg, icon, fn) {
            ...
            opts = $.extend({}, $.messager.defaults, { content: "<div class=\"" + cls + " icon iconfont newIconStyle\"></div>" + "<div class=\"newIconText\">" + opts.msg + "</div>" + "<div style=\"clear:both;\"/>" }, opts);
            if (!opts.buttons) {
                opts.buttons = [{
                    text: opts.ok,
                    onClick: function() {
        ...
        confirm: function(_2b7, msg, fn) {
            ...
            opts = $.extend({}, $.messager.defaults, { content: "<div class=\"messager-icon messager-question icon iconfont newIconStyle\"></div>" + "<div>" + opts.msg + "</div>" + "<div style=\"clear:both;\"/>" }, opts);
            if (!opts.buttons) {
                opts.buttons = [{
                    text: opts.ok,
                    onClick: function() {
        ...
        progress: function(_2b9) {
            ...
            var dlg = _2b2($.extend({}, $.messager.defaults, { content: "<div class=\"messager-progress messager-progress-NewStyle\"><div class=\"promptBox\"><div class=\"boxBody\"><div class=\"boxBodyWrapper\"><div class=\"loadingBox\"><div class=\"loading\"><div><div class=\"loading-line loading-line-l1\"></div><div class=\"loading-line loading-line-l2\"></div><div class=\"loading-line loading-line-l3\"></div><div class=\"loading-line loading-line-l4\"></div><div class=\"loading-line loading-line-l5\"></div></div><div class=\"loadingText\"><span>正在加载</span></div></div> </div></div></div><div class=\"messager-p-msg hideStyle\">" + opts.msg + "</div><div class=\"messager-p-bar hideStyle\"></div></div>", closable: false, doSize: false }, opts, {
                onClose: function() {
                    if (this.timer) {
            ...
            /*var dlg=_2b2($.extend({},$.messager.defaults,{content:"<div class=\"loading\"><div><div class=\"loading-line loading-line-l1\"></div><div class=\"loading-line loading-line-l2\"></div><div class=\"loading-line loading-line-l3\"></div><div class=\"loading-line loading-line-l4\"></div><div class=\"loading-line loading-line-l5\"></div></div></div>",closable:false,doSize:false},opts,{onClose:function(){
                if(this.timer){
                    clearInterval(this.timer);
                    }
                    if(_2b9.onClose){
...
(function($) {
    ...
    function _3be(_3bf, _3c0, _3c1) {
        ...
        //这边跟resize的插件有冲突  索性改成判断west存不存在，在animate成功的回调里面修改center的宽度***********
        /*if(!_3a3(_3c2[_3c4])){
        ...
        p.panel("panel").stop().animate(_3c8.collapse, _3c1, function() {
            p.panel("collapse", false).panel("close");
            _3c2[_3c4].panel("open").panel("resize", _3c8.expandP);
            _3c2.center.panel("resize", _3c8.resizeC);
            $(this).unbind(".layout");
